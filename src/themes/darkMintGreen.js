...
document.head.appendChild(document.createElement('style')).textContent = 'input, ::placeholder, .prefix, select{color: white!important;} #emoteSearchDiv{background: #ffffff0a!important;}'
