...
#navigationbar {
    box-shadow: 0 0 5px 0 #202225;
}
#d_disp{
   background: 0!important;
}
.menu{
    background: rgb(59, 61, 66)!important;
}
.dropmenu > div{
    border-bottom: 1.6px solid #a7a7a7!important;
}
.navbtn, .notification{
...
if(document.querySelector('#replyform, #editor')){
    window.addEventListener('load', ()=> {
        ...
        editor.head.appendChild(editor.createElement('style')).innerHTML = 'body{background: #36393f;}'
    })
}
