...
if(document.querySelector('#editor')){
    ...
    */
    ...
    <div id="emotesView" style="position: absolute; width: 100%; height: 100%; flex: 1; display: flex; flex-direction: column;"> <p class="bold padding" style=" font-size: 20px; ">Emotes</p>
    ...
    <div class="theme2" id="createEmote" style="display: none; flex-direction: column; justify-content: center; padding: 10px; padding-bottom: 5px; gap: 10px; ">
        ...
        </div><input id="emote-name" placeholder="Emote Name" class="theme1 border round" type="text" style="padding: 6px;padding-left: 10px;font-size: 14px;outline: none;"> <input id="emote-url" placeholder="Emote URL" class="theme1 border round" type="text" style="padding: 6px;padding-left: 10px;font-size: 14px;outline: none;">
    </div>
    ...
    document.head.appendChild(document.createElement('style')).textContent = `.emoteContainer{transition: .07s background; border-radius: 6px;} .backbtn:hover{background: #ffffff0f;} .sectionexpand:hover{opacity: 1!important;} .scrollemotes, .twitchscrollemotes{overflow: hidden!important;} .scrollemotes:hover, .twitchscrollemotes:hover{overflow: overlay!important;}`
    ...
    */
    ...
    addEmoteBtn.addEventListener('click', ()=> {
        if(!isCreateOpen){
            ...
            if(emoteURL.value.slice(-3) != 'png' && emoteURL.value.slice(-3) != 'gif') {emoteURL.value = 'Emote has to be a PNG or GIF.'; return}
