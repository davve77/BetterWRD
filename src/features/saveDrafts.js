...
// Add draft elements
document.getElementsByClassName('menu')[1].appendChild(document.createElement('p')).outerHTML = '<p class="dropMenu_option" onclick="showDrafts()">Drafts</p>'
...
function refreshDrafts(){
    ...
    drafts.forEach(draft => {
        ...
        draftelm.addEventListener('click', function(e) {
            ...
            hideDrafts()
            // I used .innerHTML instead of tinymce's set/getContent functions because it saves the font size and other stuff
        })
