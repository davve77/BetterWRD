...
const FontLoader = {
    initialize: async ()=> {
        chrome.storage.local.get(['font','fontImport'], saved => {
            ...
            const isDefault = saved.fontImport == 'none'
            ...
            if(!saved.font || !saved.fontImport || isDefault) return
            ...
            if(document.querySelector('footer')){
                let footerdiv = document.querySelector('footer').lastElementChild
...
// WRD Change Log
if(location.hostname == 'pastebin.com'){
