...
.then((out) => {
    if(out.released == 'yes'){
        ...
        notif.innerHTML = `<div class="theme1" style="position: relative;margin: 45px auto auto;height: 100px;width: 100%;max-width: 1100px;margin-bottom: 10px;border-radius: 8px;user-select: none;"> <img style="position: absolute;left: 0;width: 100px;height: 100%;margin-left: 15px;" src="https://i.gyazo.com/9e64301669cf394065e2a0195d7e18f4.png" draggable="false"> <div style="margin-left: 130px;height: 100%;padding: 10px;padding-left: 15px;border-radius: 0 8px 8px 0;backdrop-filter: brightness(1.5);"> <p style="font-size: 22px;font-weight: 500;display: table;margin-bottom: 10px;">BWRD Version 3.0 is out! Go check it out now.<br></p><a href="https://github.com/davve77/BetterWRD/releases/latest" class="btn btn-primary themebtn" id="carddl" style="padding: 10px 15px;font-size: 15px;font-weight: 400;display: table;border-style: none;border-radius: 10px;box-shadow: none;background: linear-gradient(to right, #8aaaff, rgba(237,98,206,0.88))!important;color: black;" type="button">Download now <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24" fill="#000000" height="20px" width="20px" style=" vertical-align: middle; "><g><rect fill="none" height="24" width="24"></rect></g><g><path d="M18,15v3H6v-3H4v3c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2v-3H18z M17,11l-1.41-1.41L13,12.17V4h-2v8.17L8.41,9.59L7,11l5,5 L17,11z"></path></g></svg> </a> <p style="font-size: 19px;color: rgba(207,207,207,0.6);display: none;">BetterWRD V4.0 is out! Go check it out.<br></p> </div> </div>`
