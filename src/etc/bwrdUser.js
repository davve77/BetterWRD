...
if(!isOnMessagePage && isOnCreatePostPage || isOnThreadPage){
    ...
    if(document.getElementsByClassName('replygroup')[0]){
        ...
        userstatsdivs.forEach(elms => {
            ...
            elms.appendChild(document.createElement('div')).innerHTML = `<span id="bwrduser" title="This user has used ${checkVersion(threadText)} when creating this post."><img id="bwrduserimg" src="https://i.imgur.com/CSDfsvi.png"></span>`
        })
    }
...
if(document.querySelector('#profile_sidecards')){
    ...
    if(hasUsedBWRD){
        ...
        // Add badge
            ...
            badge.outerHTML = `<div id="bwrdbadge" style="display: flex; user-select: none; height: 35px;gap: 8px;position: absolute;bottom: 0;right: 0;margin-right: 9px;margin-bottom: 5px; max-width: 40px;"><img src="https://i.imgur.com/CSDfsvi.png" draggable="false" style=" transform: scale(1.3); "> <span style="line-height: 35px;font-size: 16px;font-style: italic;"></span></div>`
